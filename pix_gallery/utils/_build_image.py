...
class BuildImage:
    ...
    def __init__(
        ...
        mode: ModeType = "RGBA",
        font: str | Path | FreeTypeFont = "CJGaoDeGuo.otf",
        font_size: int = 20,
    ...
    def build_text_image(
        cls,
        text: str,
        font: str | FreeTypeFont | Path = "CJGaoDeGuo.otf",
        size: int = 10,
        ...
        markImg.text((0, 0), text, fill=font_color, font=_font, center_type="center")
        return markImg
    ...
    def auto_paste(
        ...
        for img in img_list:
            background_image.paste(img, (_cur_width, _cur_height))
    ...
    @classmethod
    def load_font(
        cls, font: str | Path = "CJGaoDeGuo.otf", font_size: int = 10
    ) -> FreeTypeFont:
        """加载字体
    ...
    def get_text_size(
        cls,
        text: str,
        font: str | FreeTypeFont | None = "CJGaoDeGuo.otf",
        font_size: int = 10,
        ...
        return int(text_width), int(text_height + 10)
    ...
    def pic2svg(self) -> str:
        ...
        """
        buf = StringIO()
        self.markImg.save(buf, format="SVG")
        return buf.getvalue()
    ...
    def circle(self) -> Self:
        ...
        mask = mask.resize(self.markImg.size, Image.LANCZOS)  # type: ignore
    ...
    def transpose(self, angle: Literal[0, 1, 2, 3, 4, 5, 6]) -> Self:
        ...
        返回:
            BuildImage: Self
        """
        self.markImg.transpose(angle)  # type: ignore
        return self
